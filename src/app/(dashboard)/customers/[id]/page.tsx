...
export default function CustomerDetailPage() {
  ...
  const statusOptions = ["LEAD", "ACTIVE", "INACTIVE", "CHURNED"];
  ...
  if (!customer) {
    return <div className="text-center py-8 text-slate-600">Customer not found</div>;
  }
    ...
    <div className="space-y-6 max-w-4xl">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-slate-600 mt-1">{customer.companyName || "No company"}</p>
          </div>
        </div>
        <button
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-lg border border-slate-200 p-6">
            <h3 className="font-semibold text-slate-900 mb-4">Created On</h3>
